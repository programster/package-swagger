...
final class DefinitionProperty implements DefinitionPropertyInterface
{
     ...
     */
    public static function createBasic(string $name, Type $type, string $description) : DefinitionProperty
    {
     ...
     */
    public static function createArray(string $name, Type $itemType, string $description)
    {
        $definitionProperty = new DefinitionProperty();
        $definitionProperty->m_name = $name;
